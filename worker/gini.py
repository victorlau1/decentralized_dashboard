...
def nodeDecentralizationCountry(filename, image_path):
    dic = dict() 
...
def clientDecentralization(filename, image_path):
    dic = dict()
    ...
    if os.path.isfile(filename):
        for f in open(filename).read().splitlines():
            try:
                data = json.loads(f)
                i = data['Client'] + ':' + data['ClientVersion']
                if i not in dic.keys():
                    dic[i] = 0
                dic[i] += 1
            except: 
...
nodeDecentralizationCountry('/home/evorun/workspace/decentralized_dashboard/data/transformed/ethereum_client_2021-12-23.json', 'images/node_decentralization/ethereum.png')
nodeDecentralizationCountry('/home/evorun/workspace/decentralized_dashboard/data/transformed/bit_nodes_2021-12-23_22:44:25.240090637.json', 'images/node_decentralization/bitcoin.png')
nodeDecentralizationCountry('/home/evorun/workspace/decentralized_dashboard/data/transformed/val_nodes_2021-12-23 22:44:25.240090637 -0800 PST m=-259199.999388838.json', 'images/node_decentralization/solana.png')

clientDecentralization('/home/evorun/workspace/decentralized_dashboard/data/transformed/ethereum_client_2021-12-23.json', 'images/client_decentralization/ethereum.png')
clientDecentralization('/home/evorun/workspace/decentralized_dashboard/data/transformed/bit_nodes_2021-12-23_22:44:25.240090637.json', 'images/client_decentralization/bitcoin.png')
clientDecentralization('/home/evorun/workspace/decentralized_dashboard/data/transformed/val_nodes_2021-12-23 22:44:25.240090637 -0800 PST m=-259199.999388838.json', 'images/client_decentralization/solana.png')
